...
Libraries/System_stm32f10x/src/%.o: ../Libraries/System_stm32f10x/src/%.s
	arm-atollic-eabi-gcc -c -mthumb -mcpu=cortex-m3 -DSTM32F10X_MD -DUSE_STDPERIPH_DRIVER -I../Libraries/CMSIS/Include -I"C:\IoT\STM32\Blue Pill - STM32F103C8T6\NVIC_Example\src\inc" -I"C:\IoT\STM32\Blue Pill - STM32F103C8T6\NVIC_Example\Libraries\System_stm32f10x\inc" -I"C:\Program Files (x86)\Atollic\TrueSTUDIO for STM32 9.0.1\ARMTools\arm-atollic-eabi\include" -g -Wa,--warn -x assembler-with-cpp -specs=nano.specs -o "$@" "$<"
Libraries/System_stm32f10x/src/%.o: ../Libraries/System_stm32f10x/src/%.c
	arm-atollic-eabi-gcc -c "$<" -mthumb -mcpu=cortex-m3 -std=gnu11 -DSTM32F10X_MD -DHSE_VALUE=8000000 -I"C:\Program Files (x86)\Atollic\TrueSTUDIO for STM32 9.0.1\ARMTools\arm-atollic-eabi\include" -I"C:\IoT\STM32\Blue Pill - STM32F103C8T6\NVIC_Example\src\inc" -I"C:\IoT\STM32\Blue Pill - STM32F103C8T6\NVIC_Example\Libraries\System_stm32f10x\inc" -I../Libraries/CMSIS/Include -O0 -ffunction-sections -fdata-sections -g -fstack-usage -Wall -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -specs=nano.specs -o "$@"
